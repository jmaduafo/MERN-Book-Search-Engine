...
The goal for this assignment is to practice using GraphQL with MERN stack. GraphQL is a great tool used to mediate under and over fetching, so in the tech world, it's a very essential tool that helps to decrease bandwidth. Also we used GraphQL to authenticate User information.
